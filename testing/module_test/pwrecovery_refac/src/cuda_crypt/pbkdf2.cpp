...
/*
void DisplayGuestPassword(
        char pre_terminal[20], int pre_terminal_len,
        char hostArray[][80],int qualities, int startIndex, int endIndex,
        int *S, int saltLen,
        int *stored_pvv, int dkLen,
        int isCracked,
        unsigned char data[], unsigned int len,
        unsigned char *out, unsigned char extension,
        unsigned char *Key, fcrypt_ctx *zcx, aes_ctx *encr_ctx, z_stream *strm,
